do
    --[[ run cmd
    ./3rd/lua/lua coolape/projects/mibao/protoTool/genProtocol.lua
    --]]
    package.cpath = "luaclib/?.so"
    package.path = "lualib/?.lua;" .. "coolape/projects/mibao/protoTool/?.lua;"
    ...
    --===================================================
    --===================================================
    local keyCodeProtocolFile = "coolape/projects/mibao/protoTool/gen/KeyCodeProtocol.lua";
    local clientFilePath = "coolape/projects/mibao/protoTool/gen/".. defProtocol.name .. "Client.lua";
    local serverFilePath = "coolape/projects/mibao/protoTool/gen/".. defProtocol.name .. "Server.lua";
    ...
    local function createKeyCodeFile(m)
        ...
        if m then
            ...
            add(content, "    map.retInfor = 1")
            add(content, "    map[1] = \"retInfor\"")
