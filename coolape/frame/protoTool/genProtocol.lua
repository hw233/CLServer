do
        ...
        for name, val in pairs(map) do
            ...
            for k,v in pairs(val[2]) do
                ...
                if typeName == "table" then
                    ...
                    if stName then
                        add(ret, "    ---@field public " .. k .. " " .. getStName(stName) .. " " .. (v[2] or "" ))
                    else
    ...
    local function main()
        ...
        add(strsClientJS, "    //==============================")
        add(strsClientJS, "    /*")
        add(strsClientJS, "    * 初始化")
        add(strsClientJS, "    * url:地址")
        add(strsClientJS, "    * beforeCallFunc:请求之前的回调")
        add(strsClientJS, "    * afterCallFunc:请求结束后的回调")
        add(strsClientJS, "    */")
        add(strsClientJS, "    " .. defProtocol.name .. ".init = function(url, beforeCallFunc, afterCallFunc) {")
        add(strsClientJS, "        " .. defProtocol.name .. ".url = url")
        add(strsClientJS, "        " .. defProtocol.name .. ".beforeCallFunc = beforeCallFunc")
        add(strsClientJS, "        " .. defProtocol.name .. ".afterCallFunc = afterCallFunc")
        add(strsClientJS, "    }")
        add(strsClientJS, "    /*")
