...
function genDB.genLuaFile(outPath, tableCfg)
    ...
    table.insert(str, "function " .. name .. ":setTrigger(server, cmd)")
    table.insert(str, "    skynet.call(\"CLDB\", \"lua\", \"ADDTRIGGER\", self.__name__, self.__key__, server, cmd)")
    table.insert(str, "end")
    table.insert(str, "")
    table.insert(str, "function " .. name .. ":unsetTrigger(server, cmd)")
    table.insert(str, "    skynet.call(\"CLDB\", \"lua\", \"REMOVETRIGGER\", self.__name__, self.__key__, server, cmd)")
    table.insert(str, "end")
    table.insert(str, "")
